   ...
   return (
      <Container width="100%" textAlign="center">
         <Box
            ...
            <Typography variant="h2" color='#ffffff' padding={1} textTransform={'uppercase'}>
               About
            </Typography>
            <Typography variant="h2" color='#27AE60' padding={1} textTransform={'uppercase'}>
               Me
            </Typography>
         </Box>
         <Box
            ...
            <Box
               ...
               <Typography
                  ...
                  2021 with a degree in Information
                  Technology.My interests are in Front End
                  Engineering and I love to create beautiful
